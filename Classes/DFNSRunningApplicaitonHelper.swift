...
class DFNSRunningApplicaitonHelper:NSObject{
    ...
    static func allApplication() -> Array<NSRunningApplication> {
    ...
    /// - Returns: 返回一个进程。
    static func runningApplication(pid:Int) -> NSRunningApplication? {
    ...
    ///  获取当前程序
    static func curApplication() -> NSRunningApplication {
        return NSRunningApplication.current
        
    }
    
    // 获取当前程序的进程的信息
    static func curApplicationInfo() -> ProcessInfo {
        
        return ProcessInfo.processInfo
    }
    
    // 获取当前程序的进程的pid
    static func curApplicationPid() -> pid_t {
